...
var pTags = document.querySelectorAll("h4");

for (var i = 0; i < pTags.length; i++) {
    pTags[i].setAttribute("style", "color:blue; font-size: 30px; text: bold");
}

var paddingTag = document.querySelector("h1");

paddingTag.setAttribute("style", "padding-left: 10px; margin: 0px");

//you have to set attributes one